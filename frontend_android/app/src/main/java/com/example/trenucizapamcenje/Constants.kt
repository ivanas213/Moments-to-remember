...
object Constants {
    const val SERVER_IP_ADRESS ="http://10.107.117.58:4000/"
    ...
    const val emailAddress = "Email adresa: trenucizapamcenje@gmail.com"
    ...
    const val appointmentStory = "Naš tim je posvećen tome da vaš dan protekne besprekorno.Popunite jednostavan formular i uskoro ćemo vas kontaktirati kako " +
            "bismo dogovorili sve detalje."
    const val rate = "Oceni:"
    const val notificationsTitle = "OBAVEŠTENJA"
    const val roleError = "Pristup je dozvoljen samo kupcima"
